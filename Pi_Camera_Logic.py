...
cv2.createTrackbar("LH", "TrackingPurple", 0, 255, nothing)
cv2.createTrackbar("LS", "TrackingPurple", 164, 255, nothing)
cv2.createTrackbar("LV", "TrackingPurple", 128, 255, nothing)
cv2.createTrackbar("UH", "TrackingPurple", 32, 255, nothing)
cv2.createTrackbar("US", "TrackingPurple", 255, 255, nothing)
cv2.createTrackbar("UV", "TrackingPurple", 194, 255, nothing)
...
while(cap.isOpened()):
    ...
    purple_lines = process(res_purple)
    
    main_view = cv2.add(yellow_lines,frame)
    main_view = cv2.add(purple_lines, main_view)
